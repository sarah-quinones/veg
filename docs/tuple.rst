...
.. cpp:class:: template <typename... Ts> tuple
   ...
   .. cpp:function:: template <typename... Us>\
      ...
      | prevents rvalue tuples from selecting the copy converting constructor
   ...
   .. cpp:function:: template <typename... Us>\
      ...
      | prevents rhs from selecting the const overload
   ...
   .. cpp:function:: template <typename... Us>\
      ...
      | prevents lhs from selecting the const overload
      | viable if the previous assignment operator is not
   ...
   .. cpp:function:: template <i64 I>\
      ...
      | prevents `operator[]` from selecting the const overload
      | viable if ``0 <= I < sizeof...(Ts)`` and `move_constructible<T_I>
