...
TEST_CASE("dynamic stack: raii") {
	...
	dynstack::DynStackMut stack{from_slice_mut, buf.as_mut()};
...
TEST_CASE("dynamic stack: evil_reorder") {
	Array<unsigned char, 4096> buf{};
	veg::dynstack::DynStackMut stack{from_slice_mut, buf.as_mut()};
	auto good = [&] {
...
TEST_CASE("dynamic stack: alignment") {
	...
	veg::dynstack::DynStackMut stack{
			from_slice_mut, buf.as_mut().split_at_mut(1)[1_c]};
